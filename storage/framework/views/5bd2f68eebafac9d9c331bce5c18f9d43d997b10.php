                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if(isset(auth()->user()->role->permission['name']['user']['can-edit'])): ?>
                                        <a href="<?php echo e(route('users.edit',[$user->id])); ?>"><i class="fas fa-edit"></i></a></td>
                                    <?php endif; ?>
                                <td class="text-center">
                                    <?php if(isset(auth()->user()->role->permission['name']['user']['can-delete'])): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Employee\resources\views/admin/user/index.blade.php ENDPATH**/ ?>
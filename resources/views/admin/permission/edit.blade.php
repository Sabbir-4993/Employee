                                ...
                                <table class="table table-striped table-dark mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" name="name[project][can-delete]" @if(isset($permission['name']['project']['can-delete'])) checked @endif value="1"></td>
                                        ...
                                        <tr>
                                            <td>Requisition</td>
                                            <td><input type="checkbox" name="name[requisition][can-view]" @if(isset($permission['name']['requisition']['can-view'])) checked @endif value="1"></td>
                                            ...
                                            <td><input type="checkbox" name="name[requisition][can-delete]" @if(isset($permission['name']['requisition']['can-delete'])) checked @endif value="1"></td>
